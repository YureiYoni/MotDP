...
screen navigation():
        vbox:
            ...
            if main_menu:
                textbutton _("Галерея") action ShowMenu("galleryA")
...
screen about():
    ...
    vbox:
        ...
        ypos 0.23
        xmaximum 400
        text _("\nИгра создана Stygh (Snowstorm Quest)")
        text _("\nGUI template created by Skolaztika")
...
screen keyboard_help():
    vbox:
        ...
        vbox:
            label _("\nCtrl")
            text _("При зажатии пропускает диалоги.")
        vbox:
            label _("\nTab")
    ...
    vbox:
        ...
        vbox:
            label _("\nPage Down")
            text _("Движение к следующему диалогу.")
        vbox:
            label "\nH"
            text _("Скрывает пользовательский интерфейс.")
        vbox:
            label "\nS"
...
screen gamepad_help():
    vbox:
        ...
        vbox:
            ...
            text _("Rвижение к следующему диалогу.")
        vbox:
            label _("D-Pad, Sticks")
            text _("Перемещение по интерфейсу.")
        vbox:
            label _("Start, Guide")
            text _("Вход в игровое меню.")
